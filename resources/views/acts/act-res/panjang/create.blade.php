                    ...
                    <div class="card">
                        <div class="header">
                            <div class="media-body">
                                ...
                                <small>Pilihlah salah satu dari daftar <b>resource jangka panjang</b> yang tersedia.</small>
                            </div>
                        </div>
                        <div class="body">
                            <form class="form-horizontal"  method="post" action="{{ route('act-res.store') }}" autocomplete="on">
                                @include('acts.act-res.panjang.form')
                                <div class="row clearfix">
                    ...
                    <div class="card">
                        <div class="body bg-teal" style="text-align: center;">
                            ...
                            <button class="btn btn-block btn-lg btn-default waves-effect m-t-10 m-b-10"
                                ...
                                <b>Periksa di RESOURCE JANGKA PENDEK</b>
                            </button>
                            <span>atau</span>
                            <button class="btn btn-block btn-lg btn-default waves-effect m-t-10 m-b-10"
                                    onclick="window.location.href='{{ route('resources.create') }}?&r=1';">
                                <b>Buat RESOURCE JANGKA PANJANG baru</b>
                            </button>
                        </div>
                    </div>
                </div>
